...
class OptionGeneral(MenuWindow):
    ...
    def create_base_group(self):
        ...
        self.github_token_input.setText(self.config_manager.get_config(FsConstants.GITHUB_TOKEN_KEY))
        layout.addWidget(self.github_token_input)
        layout.addWidget(QLabel("GitHub 仓库:"))
        self.github_repo_input = QLineEdit()
        self.github_repo_input.setText(self.config_manager.get_config(FsConstants.GITHUB_REPO_KEY))
